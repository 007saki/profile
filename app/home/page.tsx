...
const PortfolioHome = () => {
  return (
    <Grid2 gap={2} container display={'flex'} alignItems={'start'} justifyContent={'start'}>
      <Grid2 flexDirection={{md:'row',sm:'row'}} alignItems={'center'} justifyContent={'center'} size={12} container display={'flex'}>
        ...
        <Stack sx={{bgcolor:'#333'}} width={'100%'} display={'flex'} justifyContent={'center'} p={4} spacing={1} direction={{md:'row',sm:'column',xs:'column'}}>
